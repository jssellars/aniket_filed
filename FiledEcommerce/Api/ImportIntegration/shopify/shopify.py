...
class Shopify(Ecommerce):
    ...
    def mapper(cls, data: List[dict], mapping: Dict) -> Dict[str, list]:
        ...
        def _get_id_from_gid(gid: str) -> Optional[str]:
        ...
        for p in data:
            ...
            filed_product = FiledProduct(
                product_id=_get_id_from_gid(product_map.get("product_id")),
                title=product_map.get("title"),
                product_type=product_map.get("product_type"),
                description=product_map.get("description"),
                vendor=product_map.get("vendor"),
                tags=product_map.get("tags"),
                image_url=product_map["image_url"]["original_src"],
                brand=product_map.get("brand"),
                availability=True,
                ...
                created_at=product_map.get("created_at", imported_at),
                updated_at=product_map.get("updated_at", imported_at),
