...
class GraphAPIRequestClientPages:
    ...
    def __init__(self,
        ...
        self.__url = Template("https://graph.facebook.com/$api_version/$business_id?fields=client_pages{id,name}&access_token=$access_token")
