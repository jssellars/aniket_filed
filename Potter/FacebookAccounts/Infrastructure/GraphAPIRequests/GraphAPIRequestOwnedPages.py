...
class GraphAPIRequestOwnedPages:
    ...
    def __init__(self,
        ...
        self.__url = Template("https://graph.facebook.com/$api_version/$business_id?fields=owned_pages{id,name}&access_token=$access_token")
