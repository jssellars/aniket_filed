...
catalog_sales_mobile_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
...
catalog_sales_mobile_instagram = CatalogNode(ContentDeliveryReport.Platform.instagram,
                                             [instagram_feed_placement, instagram_stories_placement,
                                              instagram_explore_placement])

catalog_sales_mobile_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network,
                                                    [audience_network_native_placement,
                                                     audience_network_in_stream_videos_placement,
                                                     audience_network_rewarded_videos_placement])

catalog_sales_mobile = CatalogNode(Targeting.DevicePlatforms.mobile,
                                   [catalog_sales_mobile_facebook, catalog_sales_mobile_instagram,
                                    catalog_sales_mobile_audience_network])

catalog_sales_desktop_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
                                             [facebook_in_stream_videos_placement, facebook_marketplace_placement,
                                              facebook_right_column_placement,
                                              facebook_feed_placement, facebook_video_feeds_placement,
                                              facebook_search_results_placement])

catalog_sales_desktop_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network,
                                                     [audience_network_in_stream_videos_placement,
                                                      audience_network_rewarded_videos_placement,
                                                      audience_network_native_placement])

catalog_sales_desktop = CatalogNode(Targeting.DevicePlatforms.desktop,
