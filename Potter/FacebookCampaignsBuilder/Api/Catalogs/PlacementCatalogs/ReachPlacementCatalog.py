...
reach_mobile_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook, 'Facebook', 'facebook-placement', None,
...
reach_mobile_instagram = CatalogNode(ContentDeliveryReport.Platform.instagram, 'Instagram', 'instagram-placement', None,
                                     [instagram_feed_placement, instagram_stories_placement,
                                      instagram_explore_placement])

reach_mobile_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network, 'Apps & Sites',
                                            'apps-placement', None,
                                            [audience_network_in_stream_videos_placement,
                                             audience_network_rewarded_videos_placement,
                                             audience_network_native_placement])

reach_mobile = CatalogNode(Targeting.DevicePlatforms.mobile, 'Mobile', None, None,
                           [reach_mobile_facebook, reach_mobile_instagram, reach_mobile_audience_network])

reach_desktop_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook, 'Facebook', 'facebook-placement', None,
...
reach_desktop_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network, 'Apps & Sites',
                                             'apps-placement', None,
                                             [audience_network_in_stream_videos_placement,
                                              audience_network_native_placement,
                                              audience_network_rewarded_videos_placement])

reach_desktop = CatalogNode(Targeting.DevicePlatforms.desktop, 'Desktop', None, None,
                            [reach_desktop_facebook, reach_desktop_audience_network])

reach_placement_catalog = copy.deepcopy(reach)
reach_placement_catalog.display_name = None
reach_placement_catalog.description = None
reach_placement_catalog.image_name = None
