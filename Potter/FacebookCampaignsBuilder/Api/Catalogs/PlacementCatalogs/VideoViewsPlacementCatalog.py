...
video_views_mobile_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
...
video_views_mobile_instagram = CatalogNode(ContentDeliveryReport.Platform.instagram,
                                           [instagram_feed_placement, instagram_stories_placement,
                                            instagram_explore_placement])

video_views_mobile_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network,
                                                  [audience_network_native_placement,
                                                   audience_network_rewarded_videos_placement,
                                                   audience_network_in_stream_videos_placement])

video_views_mobile = CatalogNode(Targeting.DevicePlatforms.mobile,
                                 [video_views_mobile_facebook, video_views_mobile_instagram,
                                  video_views_mobile_audience_network])

video_views_desktop_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
                                           [facebook_feed_placement, facebook_marketplace_placement,
                                            facebook_in_stream_videos_placement, facebook_video_feeds_placement,
                                            facebook_search_results_placement
                                            ])

video_views_desktop_audience_network = CatalogNode(ContentDeliveryReport.Platform.audience_network,
                                                   [audience_network_in_stream_videos_placement,
                                                    audience_network_native_placement,
                                                    audience_network_rewarded_videos_placement])

video_views_desktop = CatalogNode(Targeting.DevicePlatforms.desktop,
