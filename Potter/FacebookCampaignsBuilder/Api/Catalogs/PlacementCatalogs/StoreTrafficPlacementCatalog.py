...
store_traffic_mobile_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
...
store_traffic_mobile = CatalogNode(Targeting.DevicePlatforms.mobile,
                                   [store_traffic_mobile_facebook])

store_traffic_desktop_facebook = CatalogNode(ContentDeliveryReport.Platform.facebook,
...
store_traffic_desktop = CatalogNode(Targeting.DevicePlatforms.desktop,
