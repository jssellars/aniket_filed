...
from PotterFacebookAccounts.BackgroundTasks.Startup import startup, rabbit_logger, logger
from PotterFacebookAccounts.Infrastructure.IntegrationEvents.HandlersEnum import HandlersEnum
from PotterFacebookAccounts.Infrastructure.IntegrationEvents.MessageTypeEnum import RequestTypeEnum
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        log = LoggerMessageBase(
            mtype=LoggerMessageTypeEnum.INTEGRATION_EVENT,
            name="Potter Facebook Accounts Integration Error",
            description=str(e),
