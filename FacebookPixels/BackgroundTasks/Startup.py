...
from FacebookPixels.BackgroundTasks.Config.Config import RabbitMqConfig, FacebookConfig, SQLAlchemyConfig
...
# Log startup details
startup_log = LoggerMessageStartup(app_config=app_config, description="Facebook Pixels Background Tasks")
