...
from Turing.Infrastructure.GraphAPIRequests.GraphAPIRequestInsights import GraphAPIRequestInsights
from Turing.Infrastructure.GraphAPIRequests.GraphAPIRequestStructures import GraphAPIRequestStructures
from Turing.Infrastructure.Mappers.GraphAPIInsightsMapper import GraphAPIInsightsMapper
...
class GraphAPIInsightsHandler:
    ...
    __ids_keymap = {
        Level.ACCOUNT.value: {
            "structure": FacebookFieldsMetadata.id.field_name,
            "insight": FacebookFieldsMetadata.ad_account_id.field_name
        },

        Level.CAMPAIGN.value: {
            "structure": FacebookFieldsMetadata.id.field_name,
            "insight": FacebookFieldsMetadata.campaign_id.field_name
        },

        Level.ADSET.value: {
            "structure": FacebookFieldsMetadata.id.field_name,
            "insight": FacebookFieldsMetadata.adset_id.field_name
        },

        Level.AD.value: {
            "structure": FacebookFieldsMetadata.id.field_name,
            "insight": FacebookFieldsMetadata.ad_id.field_name
        }
    }

    __structure_insights_keymap = {
        Level.ACCOUNT.value: {
            FacebookFieldsMetadata.name.field_name: FacebookFieldsMetadata.account_name.field_name,
            FacebookFieldsMetadata.id.field_name: FacebookFieldsMetadata.ad_account_id.field_name
        },

        Level.CAMPAIGN.value: {
            FacebookFieldsMetadata.name.field_name: FacebookFieldsMetadata.campaign_name.field_name,
            FacebookFieldsMetadata.id.field_name: FacebookFieldsMetadata.campaign_id.field_name
        },

        Level.ADSET.value: {
            FacebookFieldsMetadata.name.field_name: FacebookFieldsMetadata.adset_name.field_name,
            FacebookFieldsMetadata.id.field_name: FacebookFieldsMetadata.adset_id.field_name
        },

        Level.AD.value: {
            FacebookFieldsMetadata.name.field_name: FacebookFieldsMetadata.ad_name.field_name,
            FacebookFieldsMetadata.id.field_name: FacebookFieldsMetadata.ad_id.field_name
        }
    }
    ...
    def get_insights(cls,
                     ...
                     requested_fields: typing.List[FacebookFieldsMetadata] = None) -> typing.List[typing.Dict]:
