...
from PotterFacebookProductCatalogs.Infrastructure.Domain.ProductCatalog import ProductCatalog
from PotterFacebookProductCatalogs.Infrastructure.GraphAPIHandlers.GraphAPIProductFields import \
