...
from PotterFacebookPixels.BackgroundTasks.Startup import startup, rabbit_logger, logger
from PotterFacebookPixels.Infrastructure.IntegrationEvents.HandlersEnum import HandlersEnum
from PotterFacebookPixels.Infrastructure.IntegrationEvents.MessageTypeEnum import RequestTypeEnum
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        log = LoggerMessageBase(
            mtype=LoggerMessageTypeEnum.INTEGRATION_EVENT,
            name="Potter Facebook Pixels Integration Error",
            description=str(e),
