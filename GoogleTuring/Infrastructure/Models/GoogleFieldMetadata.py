from GoogleTuring.Infrastructure.Models.ConversionFunctions import id_to_string, percentage_to_float, id_to_location_name
from GoogleTuring.Infrastructure.Models.GoogleField import GoogleField
from GoogleTuring.Infrastructure.Models.GoogleFieldType import GoogleFieldType


class GoogleFieldMetadata:
    # Attributes
    ...
    recommended_budget_amount = GoogleField(name="RecommendedBudgetAmount", field_name="RecommendedBudgetAmount", field_type=GoogleFieldType.ATTRIBUTE)
    ...
    conversino_category_name = GoogleField(name="ConversionCategoryName", field_name="ConversionCategoryName", field_type=GoogleFieldType.SEGMENT)
    ...
    active_view_measurable_cost = GoogleField(name="ActiveViewMeasurableCost", field_name="ActiveViewMeasurableCost", field_type=GoogleFieldType.METRIC)
    ...
    all_conversion_rate = GoogleField(name="AllConversionRate", field_name="AllConversionRate", field_type=GoogleFieldType.METRIC)
    ...
    conversion_rate = GoogleField(name="ConversionRate", field_name="ConversionRate", field_type=GoogleFieldType.METRIC)

    conversions = GoogleField(name="Conversions", field_name="Conversions", field_type=GoogleFieldType.METRIC)

    conversion_value = GoogleField(name="ConversionValue", field_name="ConversionValue", field_type=GoogleFieldType.METRIC)

    cost = GoogleField(name="cost", field_name="Cost", field_type=GoogleFieldType.METRIC)

    cost_per_all_conversion = GoogleField(name="CostPerAllConversion", field_name="CostPerAllConversion", field_type=GoogleFieldType.METRIC)

    cost_per_conversion = GoogleField(name="CostPerConversion", field_name="CostPerConversion", field_type=GoogleFieldType.METRIC)

    cost_per_current_model_attributed_conversion = GoogleField(name="CostPerCurrentModelAttributedConversion",
                                                               field_name="CostPerCurrentModelAttributedConversion", field_type=GoogleFieldType.METRIC)
    ...
    video_quartile_100_rate = GoogleField(name="VideoQuartile100Rate", field_name="VideoQuartile100Rate", field_type=GoogleFieldType.METRIC)

    video_quartile_25_rate = GoogleField(name="VideoQuartile25Rate", field_name="VideoQuartile25Rate", field_type=GoogleFieldType.METRIC)

    video_quartile_50_rate = GoogleField(name="VideoQuartile50Rate", field_name="VideoQuartile50Rate", field_type=GoogleFieldType.METRIC)

    video_quartile_75_rate = GoogleField(name="VideoQuartile75Rate", field_name="VideoQuartile75Rate", field_type=GoogleFieldType.METRIC)
    ...
    offline_interaction_rate = GoogleField(name="OfflineInteractionRate", field_name="OfflineInteractionRate", field_type=GoogleFieldType.METRIC)
    ...
    invalid_click_rate = GoogleField(name="InvalidClickRate", field_name="InvalidClickRate", field_type=GoogleFieldType.METRIC)
