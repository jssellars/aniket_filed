...
class AdWordsAPIInsightsHandler:
    @classmethod
    def get_insights(cls, permanent_token, client_customer_id, report, fields, time_range):
        adwords_client = cls.__build_client(client_customer_id, permanent_token)
    ...
    @classmethod
    def __build_client(cls, client_customer_id, permanent_token):
