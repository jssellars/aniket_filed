...
class AdsAPIInsightsReportHandler:
    @classmethod
    ...
    @classmethod
    def get_report_insights(cls, config, refresh_token, query_builder_request_parser):
        ...
        try:
            return report_insights_client.get_insights_report(
