...
from GoogleTuring.Infrastructure.Models.Enums.Breakdown import BREAKDOWN_TO_FIELD, DEFAULT_GEO_BREAKDOWN
from GoogleTuring.Infrastructure.PersistanceLayer.MongoIdToNameCache import MongoIdToNameCache


class GoogleTuringMongoRepository(MongoRepositoryBase):
    ...
    def __insert_locations_into_db(self, unknown_ids, adwords_client):
        self.collection = self.__location_collection_name
        location_criterion_service = adwords_client.GetService('LocationCriterionService')
