...
breakdowns_controller = "{base_url}/get-breakdowns".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerBreakdownsEndpoint, breakdowns_controller)

ad_account_insights_controller = "{base_url}/google-accounts-insights".format(base_url=config.base_url.lower())
