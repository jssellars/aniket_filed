...
class AdGroupGenderPerformanceReport(InsightsReportModel):
    table_name = TableEnum.AD_GROUP_GENDER_PERFORMANCES.value
    report_breakdowns = []
    display_name = "Ad Group - Gender Report"
    ...
    columns = json_list_encoder(AdGroupGenderColumnsMaster)
