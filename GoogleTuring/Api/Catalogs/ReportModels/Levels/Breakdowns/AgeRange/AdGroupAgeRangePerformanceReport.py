...
class AdGroupAgeRangePerformanceReport(InsightsReportModel):
    table_name = TableEnum.AD_GROUP_AGE_RANGE_PERFORMANCES.value
    report_breakdowns = []
    display_name = "Ad Group - Age Report"
    ...
    columns = json_list_encoder(AdGroupAgeRangeColumnsMaster)
