...
from GoogleTuring.Api.Catalogs.Views.ViewColumnsMaster.Levels.Breakdowns.Geo.AdGroupGeoColumnsMaster import AdGroupGeoColumnsMaster


class AdGroupGeoPerformanceReport(InsightsReportModel):
    table_name = TableEnum.CAMPAIGN_GEO_PERFORMANCES.value
    report_breakdowns = []
    display_name = "Ad Group - Geo Report"
    ...
    columns = json_list_encoder(AdGroupGeoColumnsMaster)
