...
class CampaignKeywordsPerformanceReport(InsightsReportModel):
    table_name = TableEnum.CAMPAIGN_KEYWORDS_PERFORMANCES.value
    report_breakdowns = []
    display_name = "Campaign - Keywords Report"
    ...
    columns = json_list_encoder(CampaignKeywordsColumnsMaster)
