...
from GoogleTuring.Api.Catalogs.Views.ViewColumnsMaster.AgeRangeColumnsMaster import AgeRangeColumnsMaster


class AgeRangePerformanceReport(InsightsReportModel):
    ...
    table_name = 'AgeRangePerformances'
    report_breakdowns = ['CampaignPerformances', 'AdGroupPerformances']
    columns = json_list_encoder(AgeRangeColumnsMaster)
