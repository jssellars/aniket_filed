...
class GoogleMetadataColumnsPool:
    ...
    accent_color = ColumnMetadata(GoogleFieldsMetadata.accent_color.field_name, ColumnType.text)

    account_currency_code = ColumnMetadata(GoogleFieldsMetadata.account_currency_code.field_name, ColumnType.text)

    account_time_zone = ColumnMetadata(GoogleFieldsMetadata.account_time_zone.field_name, ColumnType.text)

    ad_group_status = ColumnMetadata(GoogleFieldsMetadata.ad_group_status.field_name, ColumnType.text)

    ad_strength_info = ColumnMetadata(GoogleFieldsMetadata.ad_strength_info.field_name, ColumnType.text)

    ad_type = ColumnMetadata(GoogleFieldsMetadata.ad_type.field_name, ColumnType.text)

    allow_flexible_color = ColumnMetadata(GoogleFieldsMetadata.allow_flexible_color.field_name, ColumnType.text)

    automated = ColumnMetadata(GoogleFieldsMetadata.automated.field_name, ColumnType.text)

    base_ad_group_id = ColumnMetadata(GoogleFieldsMetadata.base_ad_group_id.field_name, ColumnType.text)

    base_campaignId = ColumnMetadata(GoogleFieldsMetadata.base_campaignId.field_name, ColumnType.text)

    business_name = ColumnMetadata(GoogleFieldsMetadata.business_name.field_name, ColumnType.text)

    call_only_phone_number = ColumnMetadata(GoogleFieldsMetadata.call_only_phone_number.field_name, ColumnType.text)

    call_to_action_text = ColumnMetadata(GoogleFieldsMetadata.call_to_action_text.field_name, ColumnType.text)

    campaign_id = ColumnMetadata(GoogleFieldsMetadata.campaign_id.field_name, ColumnType.text)

    campaign_name = ColumnMetadata(GoogleFieldsMetadata.campaign_name.field_name, ColumnType.text)
    ...
    description_1 = ColumnMetadata(GoogleFieldsMetadata.description_1.field_name, ColumnType.text)

    description_2 = ColumnMetadata(GoogleFieldsMetadata.description_2.field_name, ColumnType.text)

    device_preference = ColumnMetadata(GoogleFieldsMetadata.device_preference.field_name, ColumnType.text)
    ...
    headline = ColumnMetadata(GoogleFieldsMetadata.headline.field_name, ColumnType.text)

    headline_part_1 = ColumnMetadata(GoogleFieldsMetadata.headline_part_1.field_name, ColumnType.text)

    headline_part_2 = ColumnMetadata(GoogleFieldsMetadata.headline_part_2.field_name, ColumnType.text)

    ad_name = ColumnMetadata(GoogleFieldsMetadata.ad_name.field_name, ColumnType.text)

    id = ColumnMetadata(GoogleFieldsMetadata.id.field_name, ColumnType.text)

    ad_id = ColumnMetadata(GoogleFieldsMetadata.ad_id.field_name, ColumnType.text)
    ...
    is_negative = ColumnMetadata(GoogleFieldsMetadata.is_negative.field_name, ColumnType.text)

    label_ids = ColumnMetadata(GoogleFieldsMetadata.label_ids.field_name, ColumnType.text)

    labels = ColumnMetadata(GoogleFieldsMetadata.labels.field_name, ColumnType.text)

    long_headline = ColumnMetadata(GoogleFieldsMetadata.long_headline.field_name, ColumnType.text)
    ...
    path_2 = ColumnMetadata(GoogleFieldsMetadata.path_2.field_name, ColumnType.text)

    policy_summary = ColumnMetadata(GoogleFieldsMetadata.policy_summary.field_name, ColumnType.text)

    price_prefix = ColumnMetadata(GoogleFieldsMetadata.price_prefix.field_name, ColumnType.text)
    ...
    ad_rotation_mode = ColumnMetadata(GoogleFieldsMetadata.ad_rotation_mode.field_name, ColumnType.text)

    bidding_strategy_id = ColumnMetadata(GoogleFieldsMetadata.bidding_strategy_id.field_name, ColumnType.text)

    bidding_strategy_name = ColumnMetadata(GoogleFieldsMetadata.bidding_strategy_name.field_name, ColumnType.text)

    bidding_strategy_source = ColumnMetadata(GoogleFieldsMetadata.bidding_strategy_source.field_name, ColumnType.text)
    ...
    cpm_bid = ColumnMetadata(GoogleFieldsMetadata.cpm_bid.field_name, ColumnType.text)

    cpv_bid = ColumnMetadata(GoogleFieldsMetadata.cpv_bid.field_name, ColumnType.text)
    ...
    final_url_suffix = ColumnMetadata(GoogleFieldsMetadata.final_url_suffix.field_name, ColumnType.text)

    target_cpa = ColumnMetadata(GoogleFieldsMetadata.target_cpa.field_name, ColumnType.text)

    target_cpa_bid_source = ColumnMetadata(GoogleFieldsMetadata.target_cpa_bid_source.field_name, ColumnType.text)

    tracking_url_template = ColumnMetadata(GoogleFieldsMetadata.tracking_url_template.field_name, ColumnType.text)
    ...
    end_date = ColumnMetadata(GoogleFieldsMetadata.end_date.field_name, ColumnType.text)
    ...
    start_date = ColumnMetadata(GoogleFieldsMetadata.start_date.field_name, ColumnType.text)

    total_amount = ColumnMetadata(GoogleFieldsMetadata.total_amount.field_name, ColumnType.text)

    approval_status = ColumnMetadata(GoogleFieldsMetadata.approval_status.field_name, ColumnType.text)

    cpc_bid_source = ColumnMetadata(GoogleFieldsMetadata.cpc_bid_source.field_name, ColumnType.text)

    creative_quality_score = ColumnMetadata(GoogleFieldsMetadata.creative_quality_score.field_name, ColumnType.text)

    criteria = ColumnMetadata(GoogleFieldsMetadata.criteria.field_name, ColumnType.text)

    gender = ColumnMetadata(GoogleFieldsMetadata.gender.field_name, ColumnType.text)

    age_range = ColumnMetadata(GoogleFieldsMetadata.age_range.field_name, ColumnType.text)
    ...
    final_mobile_urls = ColumnMetadata(GoogleFieldsMetadata.final_mobile_urls.field_name, ColumnType.text)

    final_urls = ColumnMetadata(GoogleFieldsMetadata.final_urls.field_name, ColumnType.text)

    first_page_cpc = ColumnMetadata(GoogleFieldsMetadata.first_page_cpc.field_name, ColumnType.text)

    first_position_cpc = ColumnMetadata(GoogleFieldsMetadata.first_position_cpc.field_name, ColumnType.text)

    has_quality_score = ColumnMetadata(GoogleFieldsMetadata.has_quality_score.field_name, ColumnType.text)
    ...
    search_predicted_ctr = ColumnMetadata(GoogleFieldsMetadata.search_predicted_ctr.field_name, ColumnType.text)

    system_serving_status = ColumnMetadata(GoogleFieldsMetadata.system_serving_status.field_name, ColumnType.text)

    top_of_page_cpc = ColumnMetadata(GoogleFieldsMetadata.top_of_page_cpc.field_name, ColumnType.text)

    vertical_id = ColumnMetadata(GoogleFieldsMetadata.vertical_id.field_name, ColumnType.text)

    city_name = ColumnMetadata(GoogleFieldsMetadata.city_name.field_name, ColumnType.text)

    country_name = ColumnMetadata(GoogleFieldsMetadata.country_name.field_name, ColumnType.text)

    is_targeting_location = ColumnMetadata(GoogleFieldsMetadata.is_targeting_location.field_name, ColumnType.text)
    ...
    base_campaign_id = ColumnMetadata(GoogleFieldsMetadata.base_campaign_id.field_name, ColumnType.text)

    bid_modifier = ColumnMetadata(GoogleFieldsMetadata.bid_modifier.field_name, ColumnType.text)

    cpm_bid_source = ColumnMetadata(GoogleFieldsMetadata.cpm_bid_source.field_name, ColumnType.text)

    is_restrict = ColumnMetadata(GoogleFieldsMetadata.is_restrict.field_name, ColumnType.text)

    ad_network_type_1 = ColumnMetadata(GoogleFieldsMetadata.ad_network_type_1.field_name, ColumnType.text)

    ad_network_type_2 = ColumnMetadata(GoogleFieldsMetadata.ad_network_type_2.field_name, ColumnType.text)
    ...
    conversion_tracker_id = ColumnMetadata(GoogleFieldsMetadata.conversion_tracker_id.field_name, ColumnType.text)

    conversion_type_name = ColumnMetadata(GoogleFieldsMetadata.conversion_type_name.field_name, ColumnType.text)

    criterion_id = ColumnMetadata(GoogleFieldsMetadata.criterion_id.field_name, ColumnType.text)

    criterion_type = ColumnMetadata(GoogleFieldsMetadata.criterion_type.field_name, ColumnType.text)

    date = ColumnMetadata(GoogleFieldsMetadata.date.field_name, ColumnType.text)

    day_of_week = ColumnMetadata(GoogleFieldsMetadata.day_of_week.field_name, ColumnType.text)
    ...
    month_of_year = ColumnMetadata(GoogleFieldsMetadata.month_of_year.field_name, ColumnType.text)

    quarter = ColumnMetadata(GoogleFieldsMetadata.quarter.field_name, ColumnType.text)

    slot = ColumnMetadata(GoogleFieldsMetadata.slot.field_name, ColumnType.text)

    week = ColumnMetadata(GoogleFieldsMetadata.week.field_name, ColumnType.text)

    year = ColumnMetadata(GoogleFieldsMetadata.year.field_name, ColumnType.text)
    ...
    ad_group_name_segment = ColumnMetadata(GoogleFieldsMetadata.ad_group_name_segment.field_name, ColumnType.text)
    ...
    active_view_ctr = ColumnMetadata(GoogleFieldsMetadata.active_view_ctr.field_name, ColumnType.text)
    ...
    all_conversion_rate = ColumnMetadata(GoogleFieldsMetadata.all_conversion_rate.field_name, ColumnType.text)

    all_conversions = ColumnMetadata(GoogleFieldsMetadata.all_conversions.field_name, ColumnType.text)

    all_conversion_value = ColumnMetadata(GoogleFieldsMetadata.all_conversion_value.field_name, ColumnType.text)

    average_cost = ColumnMetadata(GoogleFieldsMetadata.average_cost.field_name, ColumnType.text)

    average_cpc = ColumnMetadata(GoogleFieldsMetadata.average_cpc.field_name, ColumnType.text)

    average_cpe = ColumnMetadata(GoogleFieldsMetadata.average_cpe.field_name, ColumnType.text)

    average_cpm = ColumnMetadata(GoogleFieldsMetadata.average_cpm.field_name, ColumnType.text)

    average_cpv = ColumnMetadata(GoogleFieldsMetadata.average_cpv.field_name, ColumnType.text)

    average_pageviews = ColumnMetadata(GoogleFieldsMetadata.average_pageviews.field_name, ColumnType.text)

    average_position = ColumnMetadata(GoogleFieldsMetadata.average_position.field_name, ColumnType.text)

    average_time_on_site = ColumnMetadata(GoogleFieldsMetadata.average_time_on_site.field_name, ColumnType.text)
    ...
    conversion_rate = ColumnMetadata(GoogleFieldsMetadata.conversion_rate.field_name, ColumnType.text)

    conversions = ColumnMetadata(GoogleFieldsMetadata.conversions.field_name, ColumnType.text)

    conversion_value = ColumnMetadata(GoogleFieldsMetadata.conversion_value.field_name, ColumnType.text)

    cost = ColumnMetadata(GoogleFieldsMetadata.cost.field_name, ColumnType.text)

    cost_per_all_conversion = ColumnMetadata(GoogleFieldsMetadata.cost_per_all_conversion.field_name, ColumnType.text)
    ...
    engagements = ColumnMetadata(GoogleFieldsMetadata.engagements.field_name, ColumnType.text)

    gmail_forwards = ColumnMetadata(GoogleFieldsMetadata.gmail_forwards.field_name, ColumnType.text)

    gmail_saves = ColumnMetadata(GoogleFieldsMetadata.gmail_saves.field_name, ColumnType.text)
    ...
    interaction_rate = ColumnMetadata(GoogleFieldsMetadata.interaction_rate.field_name, ColumnType.text)

    interactions = ColumnMetadata(GoogleFieldsMetadata.interactions.field_name, ColumnType.text)

    interaction_types = ColumnMetadata(GoogleFieldsMetadata.interaction_types.field_name, ColumnType.text)
    ...
    video_quartile_25_rate = ColumnMetadata(GoogleFieldsMetadata.video_quartile_25_rate.field_name, ColumnType.text)

    video_quartile_50_rate = ColumnMetadata(GoogleFieldsMetadata.video_quartile_50_rate.field_name, ColumnType.text)

    video_quartile_75_rate = ColumnMetadata(GoogleFieldsMetadata.video_quartile_75_rate.field_name, ColumnType.text)

    video_view_rate = ColumnMetadata(GoogleFieldsMetadata.video_view_rate.field_name, ColumnType.text)
    ...
    invalid_click_rate = ColumnMetadata(GoogleFieldsMetadata.invalid_click_rate.field_name, ColumnType.text)
