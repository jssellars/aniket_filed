...
class GoogleRuleBasedOptimizationBuilder:
    ...
    def set_fuzzyfier_factory(self, fuzzyfier_factory: GoogleRuleBasedOptimizationFuzzyfierFactory = None):
        self._fuzzyfier_factory = fuzzyfier_factory
        return self

    def set_rule_evaluator(self, rule_evaluator: GoogleRuleEvaluator = None):
