...
from GoogleDexter.Infrastructure.Domain.LevelEnums import LevelEnum, LevelIdKeyEnum, LevelNameKeyEnum
...
class DexterMongoRepository(MongoRepositoryBase):
    ...
    def get_recommendation_meta_information(self,
        ...
        projection = {
            ...
            LevelIdKeyEnum.ADGROUP.value: MongoProjectionState.ON.value,
            LevelNameKeyEnum.ADGROUP.value: MongoProjectionState.ON.value,
    ...
    def get_ad_account_id(self, key_value: typing.AnyStr = None, level: LevelEnum = None) -> typing.AnyStr:
        ...
        if LevelIdKeyEnum.ACCOUNT.value in ad_account_id.keys():
            ad_account_id = ad_account_id[LevelIdKeyEnum.ACCOUNT.value]
        else:
            ad_account_id = None
    ...
    def get_ads_by_adgroup_id(self, key_value: typing.AnyStr = None) -> typing.List[typing.AnyStr]:
        ...
        query = {
            LevelIdKeyEnum.ADGROUP.value: {MongoOperator.EQUALS.value: key_value},
        }
    ...
    def get_adgroups_by_campaign_id(self, key_value: typing.AnyStr = None) -> typing.List[typing.AnyStr]:
        ...
        return list(set([entry[LevelIdKeyEnum.ADGROUP.value] for entry in self.get(query, projection)]))
    ...
    def get_adgroup_id_by_campaign_id(self, key_value: typing.AnyStr = None) -> typing.AnyStr:
        ...
        return result.get(LevelIdKeyEnum.ADGROUP.value)
