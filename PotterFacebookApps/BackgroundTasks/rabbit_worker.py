...
from PotterFacebookApps.BackgroundTasks.Startup import startup, rabbit_logger, logger
from PotterFacebookApps.Infrastructure.IntegrationEvents.HandlersEnum import HandlersEnum
from PotterFacebookApps.Infrastructure.IntegrationEvents.MessageTypeEnum import RequestTypeEnum
...
def callback(ch, method, properties, body):
    ...
    try:
        ...
        log = LoggerMessageBase(
            mtype=LoggerMessageTypeEnum.INTEGRATION_EVENT,
            name="Potter Facebook Apps Integration Error",
            description=str(e),
