...
insights_with_totals_controller = '{base_url}/insights-with-totals'.format(base_url=config.base_url.lower())
api.add_resource(AdsManagerInsightsWithTotalsEndpoint, insights_with_totals_controller)

# Accounts Insights
insights_controller = '{base_url}/accounts/reports'.format(base_url=config.base_url.lower())
api.add_resource(AccountsReportInsightsEndpoint, insights_controller)

# Optimize Insights
insights_controller = '{base_url}/optimize/reports'.format(base_url=config.base_url.lower())
...
ads_manager_ag_grid_period_trend_controller = '{base_url}/ads-manager/ag-grid-insights-trend/<string:level>'.\
    format(base_url=config.base_url.lower())
...
# AdsManager Insights
insights_controller = '{base_url}/ads-manager/reports'.format(base_url=config.base_url.lower())
api.add_resource(AdsManagerReportInsightsEndpoint, insights_controller)

# Reports Insights
insights_controller = '{base_url}/reports/reports'.format(base_url=config.base_url.lower())
api.add_resource(ReportsReportInsightsEndpoint, insights_controller)

ag_grid_insights_controller = '{base_url}/ag-grid-insights/<string:level>'.format(base_url=config.base_url.lower())
api.add_resource(AdsManagerAgGridInsightsEndpoint, ag_grid_insights_controller)

views_controller = "{base_url}/views".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerCatalogsViewsEndpoint, views_controller)

views_by_level_controller = "{base_url}/views/<string:level>".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerCatalogsViewsByLevelEndpoint, views_by_level_controller)

ag_grid_views = "{base_url}/ag-grid-views/<string:level>".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerCatalogsViewsAgGrid, ag_grid_views)

accounts_element_cards_views = "{base_url}/accounts/elements-cards-views".format(base_url=config.base_url.lower())
api.add_resource(AccountsElementsViews, accounts_element_cards_views)

ads_manager_element_cards_views = "{base_url}/ads-manager/elements-cards-views".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerElementsViews, ads_manager_element_cards_views)

metacolumns_controller = "{base_url}/metacolumns".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerCatalogsMetacolumnsEndpoint, metacolumns_controller)

breakdowns_controller = "{base_url}/breakdowns".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerCatalogsBreakdownsEndpoint, breakdowns_controller)

breakdowns_combinations_controller = "{base_url}/breakdowns-combinations".format(base_url=config.base_url.lower())
...
# Report catalogs
reports_controller = "{base_url}/get-reports".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerReportsEndpoint, reports_controller)

dimensions_controller = "{base_url}/get-dimensions".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerReportsDimensionsEndpoint, dimensions_controller)

metrics_controller = "{base_url}/get-metrics".format(base_url=config.base_url.lower())
api.add_resource(AdsManagerReportsMetricsEndpoint, metrics_controller)

reporting_breakdowns_controller = "{base_url}/get-breakdowns".format(base_url=config.base_url.lower())
