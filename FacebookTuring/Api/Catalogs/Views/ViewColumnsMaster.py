...
from FacebookTuring.Api.Catalogs.Columns.MetadataColumnsPool import MetadataColumnsPool
from FacebookTuring.Api.Catalogs.Columns.ViewColumns.ViewColumn import ViewColumn
from FacebookTuring.Api.Catalogs.Columns.ViewColumns.ViewColumnCategory import ViewColumnCategory
from FacebookTuring.Api.Catalogs.Columns.ViewColumns.ViewColumnType import ViewColumnType

id = Autoincrement(0)


class ViewColumnsMaster:
        effective_status = ViewColumn(id.increment_as_string(), display_name="Status", primary_value=MetadataColumnsPool.effective_status,
                                      type_id=ViewColumnType.button.id, category_id=ViewColumnCategory.common.id, is_fixed=True)
