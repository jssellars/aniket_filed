...
RULES_ADSET_REMOVE_DEVICE = [
    RuleBase(rtype=RuleTypeEnum.AUDIENCE,
             ...
             template="Your <id=1&metric_name=RESULTS&metric_type=1&antecedent_type=8> has decreased by <id=1&value=null>% in the last "
                      "<id=1&time_interval=7> days for some of the devices you are targeting. Dexter recommends you stop targeting the "
                      "following devices <id=1&breakdown_values=null>.",
