...
RULES_ADSET_REMOVE_PLACEMENT = [
    RuleBase(rtype=FacebookRuleTypeEnum.AUDIENCE,
             ...
             template="Dexter noticed your __id=1&metric_name=RESULTS&metric_type=1&antecedent_type=8__ have "
                      ...
                      "placements you are targeting. Dexter suggests you stop targeting the following placements "
             ...
             alternative_template="Dexter noticed your __id=1&metric_name=RESULTS&metric_type=1&antecedent_type=8__ "
                                  ...
                                  "for all placements you are targeting. Dexter suggests you pause this ad set.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.PLACEMENT,
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.AUDIENCE,
             ...
             template="Dexter noticed your __id=1&metric_name=RESULTS&metric_type=1&antecedent_type=8__ have "
                      "decreased by __id=1&value=null__% in the last __id=1&time_interval=7__ days for some of the "
                      "placements you are targeting. Dexter suggests you stop targeting the "
