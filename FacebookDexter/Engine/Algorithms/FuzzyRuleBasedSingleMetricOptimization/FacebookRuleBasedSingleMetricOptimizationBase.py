...
from FacebookDexter.Engine.Algorithms.FuzzyRuleBasedSingleMetricOptimization.FacebookRuleBasedSingleMetricOptimizationBuilder import \
    FacebookRuleBasedSingleMetricOptimizationBuilder
...
class FacebookRuleBasedSingleMetricOptimizationBase(FacebookRuleBasedSingleMetricOptimizationBuilder):
    ...
    def __evaluate_rules_base(self,
        ...
        applicable_rules = self._rules.get_rules_by_action_and_time_interval(action=action,
                                                                             level=self._level,
