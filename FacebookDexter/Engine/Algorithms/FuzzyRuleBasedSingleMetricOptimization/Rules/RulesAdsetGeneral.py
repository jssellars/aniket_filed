...
RULES_ADSET_GENERAL = [
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=IMPRESSIONS&metric_type=1&antecedent_type=8__ "
                      ...
                      "This means your competitors have better ad creative or your audience saw the ads too "
                      "many times. Dexter recommends you to change the ad creative. "
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=CPM&metric_type=1&antecedent_type=8__ "
                      ...
                      " This means your audience saw the ads too many times and they are not as engaged as "
                      "before. Dexter recommends you to change the ad creative. "
                      "Check your ads now to see which one is the less performing.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=CTR&metric_type=1&antecedent_type=8__ "
                      ...
                      "resonate with current selected audience. Dexter recommends you to change the "
                      "ad creative. Check your ads now to see which one is the less performing.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
             connective=Connective(LogicOperatorEnum.AND),
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=UNIQUE_CLICKS&metric_type=1&antecedent_type=8__ "
                      ...
                      "This means your audience saw the ads too many times or your ad creative doesn't resonate with "
                      "current selected audience. Dexter recommends you to change the ad creative. "
                      "Check your ads now to see which one is the less performing.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=CPC&metric_type=1&antecedent_type=8__ "
                      ...
                      "so you're bidding against yourself. Check your audience settings.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
             connective=Connective(LogicOperatorEnum.AND),
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=SPEND&metric_type=1&antecedent_type=8__ "
                      ...
                      "Breakdown your Ad set by Placements to see which placement is "
                      "spending money without notable results.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
             connective=Connective(LogicOperatorEnum.AND),
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=SPEND&metric_type=1&antecedent_type=8__ "
                      ...
                      "target audience is too small. Try increasing your bid now by 20%.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
             connective=Connective(LogicOperatorEnum.AND),
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=ROAS&metric_type=1&antecedent_type=8__ "
                      ...
                      "We suggest you consider using lookalike audiences or custom audiences to "
                      "increase your score. Create a lookalike audience now.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
             connective=Connective(LogicOperatorEnum.AND),
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=LANDING_PAGE_CONVERSION_RATE&metric_type=1&antecedent_type=8__ "
                      ...
                      "This means your Landing Page has some issues or your ad creative doesn't resonate with the Landing Page. "
                      "Try to convert more people by writing more compelling messages that match your ads and audience's interests. "
                      "Check your ads now to see which one is the less performing.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
    ...
    RuleBase(rtype=FacebookRuleTypeEnum.BUDGET_AND_BID,
             ...
             template="Dexter noticed that your __id=1&metric_name=COST_PER_PURCHASE&metric_type=1&antecedent_type=8__ "
                      ...
                      "This means your Link Clicks decreased and less people made a purchase. "
                      "Try to get more clicks by writing more compelling messages that match your audience's interests. "
                      "Check your ads now to see which one is the less performing.",
             breakdown_metadata=BreakdownMetadataBase(breakdown=FacebookBreakdownEnum.NONE,
                                                      action_breakdown=FacebookActionBreakdownEnum.NONE),
             time_interval=DaysEnum.THREE,
