...
CAMPAIGN_TIME_BUCKETS = [
    StrategyTimeBucket(no_of_days=60, minimum_days_of_data=40, triggers=THIRTY_DAYS_BUCKET, level=LevelEnum.CAMPAIGN),
    StrategyTimeBucket(no_of_days=30, minimum_days_of_data=20, triggers=THIRTY_DAYS_BUCKET, level=LevelEnum.CAMPAIGN),
    StrategyTimeBucket(no_of_days=14, minimum_days_of_data=10, triggers=FOURTEEN_DAYS_BUCKET, level=LevelEnum.CAMPAIGN),
    StrategyTimeBucket(no_of_days=7, minimum_days_of_data=4, triggers=SEVEN_DAYS_BUCKET, level=LevelEnum.CAMPAIGN),
    StrategyTimeBucket(no_of_days=3, minimum_days_of_data=2, triggers=THREE_DAYS_BUCKET, level=LevelEnum.CAMPAIGN),
]
