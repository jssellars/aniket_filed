from Algorithms.Tools.Columns import RunStatusDexterEngineJournal
...
class JournalHelper:
    ...
    @staticmethod
    def get_search_for_other_instances_query(business_owner_id, algorithm_type, ad_account_id):
        return {
            "business_owner_id": business_owner_id,
            "algorithm_type": algorithm_type.value,
            "ad_account_id": ad_account_id
