...
from PotterFacebookAccounts.Api.Config.Config import FacebookConfig, SQLAlchemyConfig
from PotterFacebookCampaignsBuilder.Api.Config.Config import RabbitMqConfig
